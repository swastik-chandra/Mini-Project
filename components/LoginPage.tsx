...
import { AtSymbolIcon, LockClosedIcon, ArrowLeftIcon, SparklesIcon } from './Icons';
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col items-center justify-center p-4 relative animate-fade-in">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
            ...
            <p className="text-gray-500 dark:text-gray-400">Access the event management panel.</p>
        </div>
